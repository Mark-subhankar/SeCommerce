        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              >
               <b style={{fontSize : "21px", color : "blue"}}> My-ECommerce</b>
              </a>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold">
                <a href="/allproducts">Categories</a>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold">Service</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a
                  href="https://www.facebook.com/aritrasamanta2023"
                ...
                <a  width="16"
                    ...
                    viewBox="0 0 16 12"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                 href="mailto:business.co.aritrasamanta@gmail.com">
